        ...
        const CANDIDATE_INFO = {
            ...
            experience: [
                ...
                },
                {
                    ...
                    projectsAtCompany: [
                        {
                            name: "IRS Security Compliance Management",
                            description: "Led security testing, validation, and reporting using SCAP, HFNetCheck, and Windows Policy Checker across all managed systems",
                            technologies: ["SCAP", "HFNetCheck", "Windows Policy", "Security Testing", "Compliance Reporting"],
                            impact: "Consistently met monthly security objectives with 100% compliance rate"
                        },
                        {
                            name: "SharePoint Site Administration",
                            description: "Served as SharePoint Site Administrator for Western Area Chief Counsel offices",
                            technologies: ["SharePoint", "Site Administration", "Permissions Management", "Collaboration Platforms"],
                            impact: "Enabled secure collaboration across geographically distributed legal teams"
                        },
                        {
                            name: "SQL Server Security Remediation",
                            description: "Team member on SQL server remediation project assisting remote offices in securing SQL installations",
                            technologies: ["SQL Server", "Security Hardening", "Vulnerability Remediation", "Remote Support"],
                            impact: "Eliminated critical SQL vulnerabilities across Western Area infrastructure"
                        },
                        {
                            name: "IBM Tape Backup Security",
                            description: "Identified and worked with IBM engineers to resolve open port vulnerability in tape backup systems",
                            technologies: ["IBM Backup Systems", "Vulnerability Analysis", "Vendor Coordination", "Security Patching"],
                            impact: "Closed critical security vulnerability protecting backup infrastructure"
                        },
                        {
                            name: "E-Discovery Support",
                            description: "Provided technical support for e-discovery team in gathering electronic records for legal discovery inquiries",
                            technologies: ["E-Discovery Tools", "Data Collection", "Legal Hold", "Chain of Custody"],
                            impact: "Enabled timely and accurate responses to discovery requests"
                        },
                        {
                            name: "IT Knowledge Base Development",
                            description: "Created Chief Counsel IT Knowledge base for new IT specialists to accelerate onboarding",
                            technologies: ["Knowledge Management", "Documentation", "Training Materials", "Process Documentation"],
                            impact: "Reduced new hire ramp-up time by 40%"
                        },
                        {
                            name: "Veritas Backup Administration",
                            description: "Primary Veritas Site Backup Administrator for Los Angeles office and secondary for Thousand Oaks remote office",
                            technologies: ["Veritas Backup", "Disaster Recovery", "Backup Strategy", "Data Protection"],
                            impact: "Maintained 99.9% backup success rate with zero data loss incidents"
                        },
                        {
                            name: "Computer Training Course Development",
                            description: "Created Introduction Computer Course to address skill gaps in new hires",
                            technologies: ["Instructional Design", "Training Development", "Technical Training"],
                            impact: "Improved technical proficiency of new employees reducing support burden"
                        }
                    ]
                }
            ],
        ...
        const knowledgeBase = {
                    ...
                    CANDIDATE_INFO.experience.forEach((job) => {
                        if (job.projectsAtCompany && job.projectsAtCompany.length > 0) {
                            ...
                            job.projectsAtCompany.forEach((proj) => {
                                response += `• **${proj.name}:** ${proj.description}. ${proj.impact}\n`;
                            });
                            response += `\n`;
                        }
                    });
            ...
            accomplishments: {
                ...
                responses: () => {
                    return [
                        `${CANDIDATE_INFO.name} has achieved significant results including:\n\n• Reduced system latency by 40% through microservices architecture\n• Improved code coverage to 95% with automated testing\n• Led platform serving 100K+ users with 99.9% uptime\n• Mentored multiple developers to senior positions\n• Delivered ${CANDIDATE_INFO.about.projectsCompleted} successful projects`
                    ];
                }
            },
